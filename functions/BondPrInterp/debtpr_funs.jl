...
function get_pv_rfdebt(svm)
   return rf_debt(svm.pm.m, svm.c, svm.p, 
...
function get_cvm_debt_price(svm, sigma; Vt=nothing, ttmMax=nothing, 
...
function get_svm_debt_price(svm, vbl, f0mat, f1mat, f2mat, f3mat; 
	...
	bondpr_vec = @spawn [bondpr(svm, Vt, vbl, ttm, vmax, f0mat, f1mat,
				    f2mat, f3mat, fd_method=false) for
			     ttm=ttm_grid]
